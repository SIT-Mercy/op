...
import { Button, DialogActions, DialogContent, Switch, TextField, Typography } from "@mui/material"
...
export function ItemEditorDialog(props) {
  ...
  const [purchasable, setPurchasable] = useState(item !== undefined ? item.price !== null : true)
  const [rentable, setRentable] = useState(item !== undefined ? item.rent !== null : false)
